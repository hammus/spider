...
class RADSpider(scrapy.Spider):
    ...
    start_urls = [
        "http://rentadressaustralia.com/listing/14589/White-Reverie.html?searchId=59bb65bf6dcfc"
        ]

    def parse(self, response):
        # for href in response.xpath("//div[@class='thumbnail']/div[@class='caption']/h1/a/@href").extract():
        yield scrapy.Request(self.start_urls[0], callback=self.parse_details)
